...
const AdminApplicants = () => {
  ...
  const fetchApplicants = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/apply/${userToken}`);
  ...
  const handleApprove = (applicantId) => {
    axios
      .put(`${process.env.REACT_APP_BASE_URL}/api/apply/${applicantId}`, { approved: true })
      .then((response) => {
  ...
  const handleReject = (applicantId) => {
    axios
      .put(`${process.env.REACT_APP_BASE_URL}/api/apply/${applicantId}`, { approved: false })
      .then((response) => {
