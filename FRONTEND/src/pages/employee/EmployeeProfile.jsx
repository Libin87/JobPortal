...
//     try {
//       const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/Employeeprofile/profile/${userId}`);
...
//         }));
//         setPhotoPreview(`${process.env.REACT_APP_BASE_URL}/${profileData.photo}`);
//         setResumePreview(`${process.env.REACT_APP_BASE_URL}/${profileData.resume}`);
...
//         if (isProfileExists) {
//           // Update profile
//           response = await axios.put(`${process.env.REACT_APP_BASE_URL}/Employeeprofile/update/${userId}`, data, {
//             headers: {
...
//         } else {
//           // Create new profile
//           response = await axios.post(`${process.env.REACT_APP_BASE_URL}/Employeeprofile/create', data, {
//             headers: {
...
// export default EmployeeProfile;
  ...
  //               await axios.put(`${process.env.REACT_APP_BASE_URL}/user/update/${userId}`, {
  //                   name: formData.name,
  ...
  const handleSubmit = async (e) => {
    ...
    if (userId) {
        ...
        try {
            ...
            const phoneCheckResponse = await axios.get(`${process.env.REACT_APP_BASE_URL}/user/checkPhoneNumber`, {
